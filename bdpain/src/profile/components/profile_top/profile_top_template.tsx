  ...
  return (
    <>
      ...
      <div className="position-relative">
        <Image
          src={`https://www.gravatar.com/avatar/${props.user.getUserEmailHash()}?d=mp`}
      ...
      >
        <Card.Body>
          ...
          <Card.Text className="fs-4 m-0">{props.user.getUserType()}</Card.Text>
          <Card.Text className="fs-5 m-0">
            Url: {`/in/${props.user.getUrl()}`}
          </Card.Text>
          <br></br>
        </Card.Body>
      </div>
